  ...
  return (
    <>
      {isCartonboxes ? (
        <Tooltip placement="left" title={toolTipMsg}>
          ...
          >
            ...
            <div
              className="steps_detail_text_color cardMinusButtom  rounded-full w-7 h-7 text-center border border-sky-500 absolute top-2 mr-0.5 right-1 cursor-pointer "
              onClick={(e) => {
                e.stopPropagation();
                onDecrement();
              }}
      ...
      >
        ...
        <div className="text-gray-500">{item}</div>
        <div
          className="steps_detail_text_color  rounded-full cardMinusButtom w-7 h-7 text-center border border-sky-500 absolute top-2 mr-0.5 right-1 cursor-pointer "
          onClick={(e) => {
            e.stopPropagation();
            onDecrement();
          }}
