    ...
    <>
      <div className="grid grid-flow-col grid-cols-5 gap-2 mb-16">
        ...
        <div className="col-span-2">
          ...
          <div className="bannerSubTitle w-96">We Make Your Moving Easy</div>
          <p className="w-96">
            Lorem ipsum Get complete care from top to bottom with your own
            moving expert. Get complete care from top to bottom with your own
            moving expert.{" "}
          </p>
