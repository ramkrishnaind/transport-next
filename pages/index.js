  ...
  return (
    <>
      <div className="index_font_color">
        ...
        <div className="top-0 Index_background1 relative">
          <div className="bg-white radius-lg index_Calculate_price_Box px-5 py-6 ">
            <div className="flex flex-col my-3">
              <div className="index_Calculate_price_Box-text-1">Shifting Happiness</div>
              <div className="font-bold index_Calculate_price_Box-text-2 mt-2">We make your</div>
              <div className="font-bold index_Calculate_price_Box-text-2 mb-2">Moving Easy</div>
              <div>
                <button
                  type="button"
                  className="yellowButton px-3 py-2">
