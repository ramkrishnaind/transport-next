...
const Step2 = () => {
  ...
  return (
    <>
      ...
      {/* <div className="bg-white ">
              <Button
                className=" px-10 py-4 button_1 rounded-m "
                loading={loading}
              >
                Next
              </Button>
      ...
      <form className="max-w-screen-xl m-auto py-10 mt-10 px-5 border">
        <div className="flex items-center mb-5 justify-center">
          ...
          <label
            htmlFor="name"
            className="inline-block w-50 mr-1 text-gray-600"
          >
            floor with service lift
          </label>
          <Select
          ...
          <label
            htmlFor="name"
            className="inline-block w-30 mr-1 text-gray-600"
          >
            for shifting.
          </label>
        </div>
        <div className="flex items-center mb-5  justify-center">
          <label
            htmlFor="name"
            className="inline-block w-30 mr-2 text-gray-600"
          >
            I&apos;m moving to
          </label>
          <Select
