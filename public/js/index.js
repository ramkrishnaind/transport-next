!(function () {
  ...
  const t = (e, t) => {
    ...
    n.has(t) && (t = n.get(t)),
      Array.from(n.values()).includes(t) ||
        (t = `custom-${(t = (t = t.replace(/[^0-9a-z]+/i, " ").trim()).replace(
          /\s+/,
          "-"
        ))}`);
        ...
        function (e) {
          ...
          "string" == typeof s &&
            ...
            "string" == typeof i &&
              ...
              (i = i.replace(/^\//, "")),
              (o = n + i)),
            delete (u = c({ Accept: "application/json, */*;q=0.1" }, u))[
              "X-WP-Nonce"
            ],
            f &&
              ((l = JSON.stringify(f)),
  ...
  function s(e, r = {}) {
    ...
    r.submitter &&
      r.submitter.name &&
      a.append(r.submitter.name, r.submitter.value);
    const c = {
    ...
    o({
      ...
      .then((t) => {
        t.posted_data_hash &&
          ...
          ).defaultValue = t.posted_data_hash),
          "mail_sent" === t.status &&
            (e.reset(), (e.wpcf7.resetOnMailSent = !0)),
          t.invalid_fields &&
            (t.invalid_fields.forEach(i), t.invalid_fields.forEach(s)),
          e.wpcf7.parent
    ...
    p = function (e, t) {
      var n = function (n) {
        ...
        e.querySelectorAll(".wpcf7-form-control-wrap.".concat(n)).forEach(
          function (e) {
            (e.querySelector('input[name="'.concat(n, '"]')).defaultValue = ""),
