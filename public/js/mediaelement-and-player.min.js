              ...
              if (
                ...
                i.cleartracks(o),
                  ...
                  (o.captionsButton.innerHTML =
                    ...
                    '_captions" id="' +
                    o.id +
                    '_captions_none" defaultValue="none" checked disabled><label class="' +
                    i.options.classPrefix +
                  ...
                  (d.innerHTML =
                    "horizontal" === s
                      ...
                      : '<button type="button" aria-controls="' +
                        ...
                        '" aria-label="' +
                        r +
                        '" tabindex="0"></button><a href="#;" class="' +
                        a.options.classPrefix +
            ...
            if (F.IS_IE || F.IS_EDGE) {
              ...
              r.flashWrapper.appendChild(w),
                ...
                (w.outerHTML =
                  "<object " +
                  x.join(" ") +
                  '><param name="movie" defaultValue="' +
                  r.options.pluginPath +
                  r.options.filename +
                  "?x=" +
                  new Date() +
                  '" /><param name="flashvars" defaultValue="' +
                  y.join("&amp;") +
                  '" /><param name="quality" defaultValue="high" /><param name="bgcolor" defaultValue="#000000" /><param name="wmode" defaultValue="transparent" /><param name="allowScriptAccess" defaultValue="' +
                  r.options.shimScriptAccess +
                  '" /><param name="allowFullScreen" defaultValue="true" /><div>' +
