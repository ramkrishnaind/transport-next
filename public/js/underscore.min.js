...
!(function (n, r) {
    ...
    return (
      ...
      (function n(r, t, e, u) {
        ...
        if (!i) {
          ...
          if (
            o !== f &&
            !(p(o) && o instanceof o && p(f) && f instanceof f) &&
            "constructor" in r &&
            "constructor" in t
          )
            return !1;
        ...
        if (i) {
          ...
          for (; a--; ) if (!mn(r[a], t[a], e, u)) return !1;
        } else {
          var c,
            l = b(r);
  ...
  var M = l(function (u, i) {
    ...
    Gn =
      ((M.placeholder = m),
      l(function (r, t, e) {
        if (!p(r)) throw new TypeError("Bind must be called on a function");
        var u = l(function (n) {
  ...
  function I(n, r, t) {
    r = S(r, t);
    for (
      var e = !E(n) && b(n), u = (e || n).length, i = Array(u), o = 0;
      o < u;
      o++
    ) {
      var f = e ? e[o] : o;
  ...
  n = Vr({
    ...
    isEmpty: function (n) {
      if (null == n) return !0;
      var r = g(n);
      return "number" == typeof r && (v(n) || X(n) || fn(n))
        ? 0 === r
        : 0 === g(b(n));
    },
    isMatch: dn,
        ...
        return (
          ...
          r <= 0 || e < r
            ? (o && (clearTimeout(o), (o = null)),
              ...
              (c = t.apply(f, a)),
              o || (f = a = null))
            : o || !1 === u.trailing || (o = setTimeout(i, r)),
          c
        );
      }
      var o,
